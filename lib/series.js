...
const seriesReadFactory = (openSeries) => async ({dbName, seriesName, from, to = Number.MAX_VALUE, follow = true}) => {
	const series = await openSeries({dbName, seriesName, access: 'ro'});
