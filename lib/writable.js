...
class WriteStream extends stream.Writable {
	...
	async _write (chunk, encoding, callback) {
		try {
			...
			// Check timestamp to be strictly monotonically increasing
			if (chunk.timestamp <= this.lastTs) throw new Error('timestamps must be strictly monotonically increasing. Last timestamp: ' + this.lastTs);
